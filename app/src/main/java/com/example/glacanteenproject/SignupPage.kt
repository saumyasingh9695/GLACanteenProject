package com.example.glacanteenproject
                        ...
                        if (task.isSuccessful) {
                            ...
                            documentReference.set(userdetails)
                                    .addOnSuccessListener { // Log.i("info", "on success:user  profile is created" + userId_techer);
                                        ...
                                        val goToOtpPage: Intent = Intent(this, MainActivity::class.java)
                            ...
                            Toast.makeText(
                                    baseContext,
                                    "Signup failed please check and try again" + (task.exception?.message
                                            ?: String),
                                    Toast.LENGTH_SHORT
                            ).show();
                        }
